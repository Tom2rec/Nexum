...
import Recommendation from "./components/recommendationHelper.component";
            ...
            <div>
                            ...
                            <div className="navbar-nav">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right "
                                         aria-labelledby="navbarDropdownMenuLink" style={{margin: "5px"}}>
                ...
                <div className="container mt-3">
                    <Switch>
                        ...
                        <Route exact path="/locations/search" component={LocationSearch}/>
                    </Switch>
                </div>
            </div>
        );
